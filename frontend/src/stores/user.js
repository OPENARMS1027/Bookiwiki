  ...
  () => {
    ...
    const login = ({ username, password }) => {
      return new Promise((resolve, reject) => {
        axios({
          method: 'post',
          url: 'https://bookiwiki.onrender.com/accounts/login/',
    ...
    const logout = () => {
      ...
      if (token.value) {
        axios({
          method: 'post',
          url: 'https://bookiwiki.onrender.com/accounts/logout/',
          headers: {
    ...
    const getUser = (userId) => {
      return axios({
        method: 'get',
        url: `https://bookiwiki.onrender.com/user/${userId}/`,
        headers: token.value
          ? {
              Authorization: `Token ${token.value}`,
            }
    ...
    const getThisUser = () => {
      if (token.value) {
        return axios({
          method: 'get',
          url: 'https://bookiwiki.onrender.com/user/me/',
          headers: {
            Authorization: `Token ${token.value}`,
          },
        })
    ...
    const followUser = (userId) => {
      if (token.value) {
        return axios({
          method: 'post',
          url: `https://bookiwiki.onrender.com/user/follow/${userId}/`,
          headers: {
            Authorization: `Token ${token.value}`,
          },
        })
